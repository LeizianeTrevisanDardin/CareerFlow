...
export default async function DashboardPage() {
  ...
  if (resumeAnalysisError) {
    console.error(
      "Error loading latest resume score:",
      resumeAnalysisError
    );
  }

  const latestResumeScore =
    latestResumeAnalysis?.overall_score ??
    null;

  const resumeScoreDescription =
